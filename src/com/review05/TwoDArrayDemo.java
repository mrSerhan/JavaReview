...
public class TwoDArrayDemo {
	...
	public static void main(String[] args) {
		...
		// Let us initialize some values for first row = row index 0	
		numbers[1][0] = 9;
		numbers[1][1] = 6;
		numbers[1][2] = 2;
		numbers[1][3] = 8;
		...
		// Let us initialize some values for third row = row index 0 
		numbers[2][0] = 3;
		numbers[2][1] = 0;
		numbers[2][2] = 8;
		numbers[2][3] = 5;
		...
		// let`s print forth element in first row
		System.out.println("forth element in first row "+numbers2 [0][3]);
